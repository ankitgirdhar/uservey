...
public class SendgridService {
    ...
    public String sendMail(Survey survey, String username) throws IOException, MessagingException {
        ...
        String mailContent = new StringBuilder()
                ...
                .append("<div>").append("<a href=https://uservey.herokuapp.com/sendgrid/response/").append(survey.getId()).append("/yes>Yes</a>")
                .append("</div>")
                .append("<div>")
                .append("<div>").append("<a href=https://uservey.herokuapp.com/sendgrid/response/").append(survey.getId()).append("/no>No</a>")
                .append("</div>")
                .append("</div>")
                .append("</body>")
                .append("</html>")
